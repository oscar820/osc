...
namespace QTool.QFixed
{
    public class ValueTable
    {
        ...
        public ValueTable(Fixed start, Fixed end, Fixed[] table)
        {
            this.table = table;
            this.start = start;
            this.end = end;
        ...
        public Fixed GetKey(Fixed value)
        {
            ...
            return Find(value, 0, table.Length-1);
        }
        ...
        public Fixed GetValue(Fixed key)
        {
            ...
            {
                return MathFixed.Lerp(table[index], table[index + 1], t - index);
            }
        }
    }
    /// <summary>
