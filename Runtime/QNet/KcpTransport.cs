...
namespace QTool.Net
{
    ...
    public class KcpTransport : QNetProtocol
    {
        ...
        static Channels FromKcpChannel(KcpChannel channel) =>
           channel == KcpChannel.Reliable ? Channels.Reliable : Channels.Unreliable;

        static KcpChannel ToKcpChannel(Channels channel) =>
        ...
        public override void ClientSend(ArraySegment<byte> segment, Channels channelId)
        {
        ...
        public override void ServerSend(int connectionId, ArraySegment<byte> segment, Channels channelId)
        {
        ...
        // max message size
        public override int GetMaxPacketSize(Channels channelId =0)
        {
        ...
        public override int GetBatchThreshold(Channels channelId) =>
