...
public static class QFlowNodeTest
{
    ...
    public static void ListTest([QFlowPort] List<int> list, List<Vector3> v3List, [QFlowPort]List<Vector3> v3FlowList,int[] intArray, [QFlowPort,QOutputPort] bool[] boolArray)
    {
